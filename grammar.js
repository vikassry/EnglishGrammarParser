...
var o=function(k,v,o,l){for(o=o||{},l=k.length;l--;o[k[l]]=v);return o},$V0=[1,5],$V1=[5,11];
var parser = {trace: function trace() { },
yy: {},
symbols_: {"error":2,"expressions":3,"e":4,"EOF":5,"SENTENCE":6,"SUBJECT":7,"VERB":8,"OBJECT":9,"DOT":10,"NOUN":11,"$accept":0,"$end":1},
terminals_: {2:"error",5:"EOF",8:"VERB",9:"OBJECT",10:"DOT",11:"NOUN"},
productions_: [0,[3,2],[4,2],[4,1],[6,4],[7,1]],
...
table: [{3:1,4:2,6:3,7:4,11:$V0},{1:[3]},{5:[1,6],6:7,7:4,11:$V0},o($V1,[2,3]),{8:[1,8]},{8:[2,5]},{1:[2,1]},o($V1,[2,2]),{9:[1,9]},{10:[1,10]},o($V1,[2,4])],
...
rules: [/^(?:\s+)/,/^(?:ram|sita\b)/,/^(?:likes|hates\b)/,/^(?:tea|coffee|butter|cheese\b)/,/^(?:$)/,/^(?:\.)/],
